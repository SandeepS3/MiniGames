...
tr = 0; mr = 0; br = 0; tm = 0; mm = 0; bm = 0; tl = 0; ml = 0; bl = 0; XWon = False; OWon = False
    ...
    while True:
        ...
        if first.lower() == 'x':
            ...
            try:        
                ...
                if (tr == 1 and tm == 1 and tl == 1):
                    XWon = True
                if (mr == 1 and mm == 1 and ml == 1):
                    XWon = True
                if (br == 1 and bm == 1 and bl == 1):
                    XWon = True
                if (tr == 1 and mr == 1 and br == 1):
                    XWon = True
                if (tm == 1 and mm == 1 and bm == 1):
                    XWon = True
                if (tl == 1 and ml == 1 and bl == 1):
                    XWon = True
                if (tr == 1 and mm == 1 and bl == 1):
                    Won = True
                if (tl == 1 and mm == 1 and br == 1):
                    XWon = True

                if (tr == 2 and tm == 2 and tl == 2):
                    OWon = True
                if (mr == 2 and mm == 2 and ml == 2):
                    OWon = True
                if (br == 2 and bm == 2 and bl == 2):
                    OWon = True
                if (tr == 2 and mr == 2 and br == 2):
                    OWon = True
                if (tm == 2 and mm == 2 and bm == 2):
                    OWon = True
                if (tl == 2 and ml == 2 and bl == 2):
                    OWon = True
                if (tr == 2 and mm == 2 and bl == 2):
                    OWon = True
                if (tl == 2 and mm == 2 and br == 2):
                    OWon = True
